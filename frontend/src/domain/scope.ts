...
// Data scoping. The demo server applies these to every response; the UI never relies on hiding.
// - admin: everything
...
export const canSeeClaim = (user: User, row: Scoped, dealers: readonly Dealer[]) =>
